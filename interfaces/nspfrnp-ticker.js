...
(function () {
    ...
    var FEED_MS = 360000;
    var BREAK_MS = 30000;
    var FIRST_FEED_ANNOUNCEMENT = 'AT THIS BREAKING STORY OF THE BISON APPEARING OVER THE NORTH PAUL! AURORA! BEHOLD! HOUDINI SPEAKS. FROM THE OTHER SIDE. · NSPFRNP CONSOLE TICKER · OH LINE BROADCAST · 120 BPS CHIRP · WEEK-LONG 9 SPOT · CLICK ANY ITEM FOR DETAILS · 6 MIN FEED · 30 SEC BREAK · RENO EXPERIENCE + ALL FEEDS CONTINUOUS · NSPFRNP TICKER SNAP · ';
    var DEFAULT = 'TICKER FEEDS ON OH LINE · 120 BPS CHIRP · POST-GAME GLOBAL 7.83 Hz · FULL NSPFRNP · RENO_ANCHOR · VIBELANDIA_OPEN · OFFICE_HOURS_FREE_CONSULTATION · GOLD_HEARTS · WELCOME · ';
