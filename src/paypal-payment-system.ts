...
export const PAYMENT_PLANS: Record<string, PaymentPlan> = {
  ...
  'campus-rj-half-day': { id: 'campus-rj-half-day', name: 'Vibelandia-RJ Half-Day', description: 'Half-day Vibelandia-RJ Campus — Rio Iate Club, RJ HQ', price: 1000, category: 'campus', tier: 1 },
  ...
  'campus-day': { id: 'campus-day', name: 'Half-Day', description: 'Half-day campus experience (alias)', price: 1000, category: 'campus', tier: 1 },
