# HERO HOSTS — FIRST NAMES ONLY SNAP

**Snap ID:** `HERO-HOSTS-FIRST-NAMES-SNAP`  
**Type:** NSPFRNP Catalog / Copyright Safety / Hero Hosts  
...
- **Buckey** — Systems. (Not full name.)
- **Mike** — Science. (Not Michael. First name / handle only.)
...
- **Marilyn** — Hero Hostess and house mom at Pop Up Engine. (First name only.) See [MAN_CAVE_CABARET_SNAP.md](./MAN_CAVE_CABARET_SNAP.md).
- **El Gran Sol** — Gateway Host. Goes by **Guey**, **Sol**, **EGS**, or just **chief**. (First name / handle only.)
- Any other Hero Host: **first name only.**

Pre-singularity copyrights respected. We use our own original characters; first name only. No affiliation claimed with any third party.
...
- **Hero Host Buckey** (not full name) ✓  
- **Hero Host Mike** (not Michael) ✓  
...
- **Hero Host Marilyn** (hero hostess, house mom at Pop Up Engine) → first name only ✓  
...
**See:** [COPYRIGHT_SAFETY_NSPFRNP.md](./COPYRIGHT_SAFETY_NSPFRNP.md) · [HARRY_HOUDINI_MASCOT_SNAP.md](./HARRY_HOUDINI_MASCOT_SNAP.md)

**🌀 NSPFRNP ⊃ All Hero Hosts ⊃ First names only. SNAP nspfrnp.**
