# Social Media Campaign Copy — X, Facebook, Instagram

**Use:** One-liner, one paragraph, and three paragraphs for X (Twitter), Facebook, and Instagram.  
**Brand:** VIBELANDIA! · Mark Twain's Post-Singularity Reno · The Great Reveal March 20, 2026  
**Status:** ⚡ ACTIVE

---

## LINKS (include in every post where possible)
...
## 1 PARAGRAPH (FB post, IG caption, X thread opener)
...
| Platform | Use |
|----------|-----|
| **X (Twitter)** | 1-liner or first sentence of 1 paragraph; thread with 1 or 3 paragraphs. **Always add The Experience + The Blueprints links** (in thread or bio). |
| **Facebook** | 1 paragraph (standard post) or 3 paragraphs (long post / note). Add CTA: MAKE YOUR RESERVATIONS NOW + **The Experience** and **The Blueprints** links. |
| **Instagram** | 1-liner in bio; 1 paragraph in caption (first line = hook); 3 paragraphs for carousel or long caption. **Put The Experience + The Blueprints links in bio or first comment.** Hashtags: #Vibelandia #RenoForVibers #TheGreatReveal #PostSingularity |
