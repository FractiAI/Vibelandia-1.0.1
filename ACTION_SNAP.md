...
- **Timestamps:** Kept so that at the end we can write up a report (e.g. authored by the protagonist — e.g. Harry — details and magician's trick).
...
**Canonical:** [protocols/SEED_EDGE_EPISODE_FORMAT_ACTION_LIVE_NSPFRNP.md](protocols/SEED_EDGE_EPISODE_FORMAT_ACTION_LIVE_NSPFRNP.md) — Seed:Edge episode format, Action! live, creator/executive commands.
