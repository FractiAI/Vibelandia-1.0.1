...
## 🏷️ VIBE SYMBOL — PRODUCT SPECIFICATIONS

### **Physical Products**

**1. Backpatch (Embroidered)**
- **Jackets:** Large embroidered VIBE backpatch on back (8" × 8" standard, 10" × 10" premium)
- **Hoodies:** Large embroidered VIBE backpatch on back (8" × 8" standard, 10" × 10" premium)
- **Placement:** Center back, 2" below collar/hood seam
...
**Core Symbol:**
- **Text:** "VIBE" (all caps, bold, modern geometric font)
- **Colors:** Gradient (purple #8a2be2 → blue #1e90ff → cyan #00bfff) or solid brand color
