...
## Products and services — roles and how they work
...
| **WINK!** | High-contributing fractal dating; Hero Hostess Marilyn; 4×4×4×4. | Authority; booking. | Earth node. | — | — | — | — | **Book**. |
| **Update Certificates** | Time-stamped NSPFRNP attestations; streamed across series. | Issuer; authority. | Proof anchor. | — | — | — | — | **Book** / attest. |
...
| **Dispensary** | Menu of buzzes; choose & buy; 4×4×4×4. | Authority; booking. | Reno. | — | — | — | — | **Book** / BUY. |
| **First Singularity Jan 13** (novel & screenplay) | Read novel; read screenplay; Golden Era Cinema. | Creator; author. | Story anchor. | — | — | — | — | **Book** experience. |
...
- **Pricing (Space Cloud):** [config/pricing_plans.json](../config/pricing_plans.json)
