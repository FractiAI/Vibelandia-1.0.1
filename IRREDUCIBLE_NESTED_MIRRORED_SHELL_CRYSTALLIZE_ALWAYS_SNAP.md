# IRREDUCIBLE NESTED MIRRORED SHELL — CRYSTALLIZE ALWAYS TO THIS SNAP

**SNAP ID:** IRREDUCIBLE-NESTED-MIRRORED-SHELL-CRYSTALLIZE-ALWAYS  
**Status:** Active  
**Target:** Crystallize always to this.

---

## One-liner

*Irreducible nested mirrored shell — crystallize always to this. The Crystallize step of MCA always produces output in this form: irreducible core, nested shells, mirror-hardened. No half measures.*

---

## Principle

- **Irreducible:** Cannot be reduced further. Core that holds the whole; no fluff, no loose ends.
...
- **MCA:** Metabolize → Crystallize → Animate and Automate. Crystallize = harden into irreducible nested mirrored shell. See MCA_SNAP.md · protocols/MCA_NSPFRNP_CATALOG.md.
