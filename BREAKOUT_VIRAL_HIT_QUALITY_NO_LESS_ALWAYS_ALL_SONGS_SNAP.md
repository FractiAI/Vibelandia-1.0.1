...
- **Scope:** All songs from Hero Jo's Golden Backdoor Hit Factory, Text-to-Track Motor, Ultimate Baller V Music Channel, Hero Jo Classical — every release targets this bar. Why not.
...
- **Music Studio:** [interfaces/music-studio.html](interfaces/music-studio.html) — quality bar stated; all tracks aim viral hit quality.
- **Text-to-Track Motor:** [interfaces/text-to-track-motor.html](interfaces/text-to-track-motor.html) — target: breakout viral hit quality; Layer 0 WAV = brief / stepping stone.
- **Song pages (Te Quiero Mucho Baby, Dorila Gao, etc.):** Lyrics + brief; production delivers viral hit quality.
- **Office Hours · Launch Pad:** When selling or describing music product, use this bar.
