...
## 90-minute format (carry)

**Target:** One good hour and a half. **Spine:** Space Cloud assets. Not a space car — the **assets** (Reno Downlink, Solar Pipe, 3I/ATLAS Deep Space, Exascale Triangulation, plus Space Assets Hub: Sun/AR4366, 3I ATLAS, OH Line, Sag A*·SMACS 0723, Ionosphere/Schumann, Poles/Aurora 3D) carry the runtime. Comedy, guest spots, and MCA beats ride on that spine.

- **Cold Open** (3–5 min) — Seed · Reno Downlink · you’re here.
- **Act 1** (20–25 min) — Engine · Solar Pipe · first comedy block, BDE George or opener.
- **Act 2** (20–25 min) — Asset · 3I ATLAS · Space assets in the room; middle block.
- **Act 3** (20–25 min) — Exascale Triangulation · Sag A* · SMACS 0723 · peak, guest spots.
...
- [bde-george-first-routine.md](bde-george-first-routine.md) — BDE George · First stand-up · The Spike and Wag · 10 min
- [space-cloud-comedy-90-min.md](space-cloud-comedy-90-min.md) — 90-min run · Space Cloud assets carry · Comedy catalog spine

---

## Space Cloud assets (not space car)
