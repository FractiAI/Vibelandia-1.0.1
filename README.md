...
- **Bolívar Returns (Arturo First Three)** — Full novel (~20k words). Petrochemical Division · NSPFRNP. Pru and Arturo roll out the first major reboot in Caracas; first three leads Peniza, Carlos, Enrique; Launch Week, long weekend caravan to Higuerote (bonfires, tambor trance, Mari G), then install. [Novel →](deliverables/Arturo_First_Three_Post_Singularity_Energy_Layer_NOVEL.md)
...
- **Post-Singularity Card Deck** — Full 52 card faces and full game instructions (real live game): **Vibelandia Golden Draw** (multiplayer), **Golden Seven Solitaire**. Golden Lucky Seven · Golden Royal Flush. [Card faces & game catalog →](catalogs/post-singularity-card-deck/CARD_FACES_AND_FULL_GAME_INSTRUCTIONS.md) · [Casino →](https://psw-vibelandia-sing4.vercel.app/interfaces/casino.html)
