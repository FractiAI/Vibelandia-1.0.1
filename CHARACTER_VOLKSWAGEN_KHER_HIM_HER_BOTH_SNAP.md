...
- [data/character-volkswagen-kher-raw-capture.md](data/character-volkswagen-kher-raw-capture.md) — Raw capture
- Goldilocks — extract common ground between generations; see GOLDILOCKS_EARTH_NOW_MISSION_SNAP.md
- Old School label / Chairman Chairman — old school vibe; OLD_SCHOOL_LABEL_CHAIRMAN_CHAIRMAN_HIT_FACTORY_SNAP.md
