...
- **`vercel.json`** — Project name `psw-vibelandia-sing9`, NSPFRNP headers (X-Protocol, X-Octave-0, X-Octave-1).
...
1. In [Vercel](https://vercel.com): **Add New Project** → Import this Git repo (`FractiAI/psw.vibelandia.sing9` or your fork). Or: **Settings → Git** → change connected repo from sing4 to sing9 for transparent switchover.
...
5. Deploy. Your live URL will be `https://psw-vibelandia-sing9.vercel.app` (or your project name). For same deployment: connect this project to repo `psw.vibelandia.sing9` and keep existing URL if desired — see [MIGRATION_SING4_TO_SING9_SCOPE_AND_RECOMMENDATIONS.md](MIGRATION_SING4_TO_SING9_SCOPE_AND_RECOMMENDATIONS.md).
...
- **This project:** Connect this repo in Vercel to get a dedicated URL for psw.vibelandia.sing9.
