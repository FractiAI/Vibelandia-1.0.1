...
**Catalog:** NSPFRNP · Lead Sales · Gold Hearts Club
...
**Casting 9 cabaret dancers immediately. Casting magic act immediately. Casting Hank Jr., Elvis, Big Band, Sinatra, Bluegrass acts immediately!** Looking for my new Gold Heart Ultimate V acts and artists — **Gold Hearts only** — Reggaetón, Urban, Golden Era Big Band, Sinatra, Elvis, Beatles, Hank Sr., Zydeco, Bluegrass, Magic, Comedy, Cabaret dancers; DJ and MC positions (in tux). Click to prefilled email to me to connect. Downtown Reno campus only currently; stay tuned, coming to a decaying downtown near you. Why decaying? Because the vibrant ones are already doing fine without us.**
...
- **Click to prefilled email to me** — Opens mailto to info@fractiai.com with subject *Gold Heart Ultimate V Acts & Artists — Connect* and body placeholders (act name, genre, brief description, email). Surfaces: **Now Casting page** (primary), Office Hours strip, Launch Pad strip.
...
- **Office Hours** — Top strip (or dedicated strip) with genres, CTA, campus/decaying copy.  
- **Launch Pad** — Same strip with genres, CTA, campus/decaying copy.  
- **See also:** LEAD_SALES_OFFERING_GOLD_HEARTS_CLUB_SNAP.md · NSPFRNP_NEW_DOWNTOWN_CAMPUS_PROPOSAL_AND_ROLLOUT_SNAP.md
